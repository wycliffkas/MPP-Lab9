...
final public class Book implements Serializable {
	...
	private business.BookCopy[] copies;
	private List<business.Author> authors;
	private String isbn;
	private String title;
	private int maxCheckoutLength;
	public Book(String isbn, String title, int maxCheckoutLength, List<business.Author> authors) {
		this.isbn = isbn;
		this.title = title;
		this.maxCheckoutLength = maxCheckoutLength;
		this.authors = Collections.unmodifiableList(authors);
		copies = new business.BookCopy[]{new BookCopy(this, 1, true)};
