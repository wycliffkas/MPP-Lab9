...
public class Main {
	List<lesson9.labs.prob2.Order> orders;
	...
	private void loadOrderData() {
		...
		lesson9.labs.prob2.Order o = new lesson9.labs.prob2.Order(LocalDate.of(2011, 10, 5), "10-210", "1001", 2, 11);
		o.addOrderItem("1002", 1, 23);
		o.addOrderItem("1003", 1, 45);
		orders.add(o);
		
		o = new lesson9.labs.prob2.Order(LocalDate.of(2001, 11, 15), "11-220", "1015", 2, 33);
		...
		o = new lesson9.labs.prob2.Order(LocalDate.of(2011, 10, 5), "10-210", "1022", 1, 80);
